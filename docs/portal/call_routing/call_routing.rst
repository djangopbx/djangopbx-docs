...
The **Call Routing** menu is primarily aimed at the superuser to allow the configuration
of dialplans (:doc:`/admin/dialplan_manager/dialplan_manager`) that are not easily created or editied within the :doc:`/admin/admin`.

The **Call Routing** menu does contain one non superuser item **Call Routing**, this allows end users to update
